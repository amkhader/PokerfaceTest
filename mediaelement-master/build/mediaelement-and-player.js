			...
			redConfused =
				...
				.bind('click', function() {  
					if (!media.paused){
						...
						var JargonFun = '<script>function jargonpopup(){var j = $.inArray(currentSubNum, JargonSubNum);if (j > -1){htmlQ2 = "<h1>Are you confused by ".concat(JargonWords[j]).concat("?</h1>");document.documentElement.a.innerHTML =htmlQ2; };}</script>'
