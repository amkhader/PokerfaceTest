			...
			redConfused =
				...
				.bind('click', function() {  
					if (!media.paused){
						...
						var JargonFun = '<script>function jargonpopup(){var j = $.inArray(currentSubNum, JargonSubNum);if (j > -1){htmlQ2 = "<h1>Are you confused by ".concat(JargonWords[j]).concat("?</h1>");popup.open(htmlQ2.concat(htmlButtons).concat(htmlButtonsJargon), "html", $("a.html_popup"));}}'
