			...
			redConfused =
				...
				.bind('click', function() {  
					if (!media.paused){
						...
						var htmlButtonsRewind = '<div id="container"><button onclick="document.getElementById("replace1").close()" id="button1">YES</button> <button onclick="rewindFunction()" id = "button2">NO, REWIND</button></div>';
