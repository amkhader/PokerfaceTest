			...
			redConfused =
				...
				.bind('click', function() {  
					if (!media.paused){
						...
						var htmlButtonsRewind = '<div id="container"><button onclick="location.href="#replace2";" class="default_popup" id="button1">YES</button> <button onclick="rewindFunction()" id = "button2">NO, REWIND</button></div>';
