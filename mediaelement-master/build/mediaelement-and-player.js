		...
		buildoverlays: function(player, controls, layers, media) {
			...
			redConfused =
				...
				document.getElementById("redCon").onclick = function(){
					...
					var RewindFun = '<script>function rewindFunction() {console.log(currentSubNum); document.getElementById("player1").currentTime = track.entries.times[currentSubNum-1]["start"]; currentSubNum--; }</script>';
					...
					var JargonFun = '<script>function jargonFunction() {document.getElementById("container").innerHTML =\' الطليعي : \\n  الطليعي يعني الطَّورُ الأَوَّل في الانْقِسام \\n <h3>Did this help? Why/Why not?</h3> <textarea id = \"textArea\"></textarea><div onclick="savetextarea()" id="submit" type="button" class="popup_close">Submit</div>\';} </script>';
