			...
			redConfused =
				...
				.bind('click', function() {  
					if (!media.paused){
						...
						$('a.html_popup').popup({
						  content : '<h1>Are you confused by something in this frame?</h1><button onclick="jargonFunction()">YES</button><script>function jargonFunction() {document.getElementById('jargonButton').innerHTML = 'This word means...'; }</script>',
						  type : 'html'
						});
