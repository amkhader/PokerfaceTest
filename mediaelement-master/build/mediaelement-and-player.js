		...
		buildoverlays: function(player, controls, layers, media) {
			...
			redConfused =
				...
				document.getElementById("redCon").onclick = function(){
					...
					var MTEFunction = '<script>function MTEFunction() {window.csvResult.push(currentSubNum + ",MTE"); makeLink(window.csvResult,"input"); document.getElementById("container").innerHTML = altTranslations[currentSubNum] + \' :ويمكن أيضا أن تترجم هذه ل \\n \' +"(via Google translate \\n)" +\'\\n <h3>كان ذلك مفيدا؟ لماذا؟</h3> \\n <button onclick="SetButtonYes()">نعم</button><button onclick="SetButtonNo()">لا</button> \\n <textarea id = \"textArea\"></textarea><button onclick="savetextareaFeedback()" id="submit" type="button">Submit</button>\';} </script>';
