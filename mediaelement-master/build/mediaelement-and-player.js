			...
			redConfused =
				...
				document.getElementById("redCon").onclick = function(){
					if (!media.paused){
						...
						$('a.button').popup({backOpacity : 0.5, keepInlineChanges : false, modal : true, content: html_content, type : 'html', afterOpen: function(){if (document.getElementById('submit')!= null){$('button').click(function(){this.close();});}}})
