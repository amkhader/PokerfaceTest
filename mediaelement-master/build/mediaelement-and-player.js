			...
			redConfused =
				...
				.bind('click', function() {  
					if (!media.paused){
						...
						var JargonFun = '<script>function jargonFunction() {document.getElementById("container").innerHTML =\' prophase - الطليعي يعني الطَّورُ الأَوَّل في الانْقِسام<textarea id = \"textArea\"></textarea><button onclick="savetextarea()" type="button">Submit</button>\';} </script>';
